export default {
  _widgetLabel: 'Perfil de elevacion',
  _widgetDescription: 'Widget para crear perfiles de elevacion desde lineas de uno o multiples segmentos sobre un mapa o escena.',
  mapLoadingMsg: 'Please wait while the map is loading',
  _action_select_label: 'Ver perfil',
  _action_view_label: 'Ver perfil de elevacion',
